# highlight all the comments below and Shift + Enter to uncomment.
# CuPy with GPU (measuring Laplace convolutions), run this in Google Colab
...
#     kernel = cp.asarray([[0.00, 0.25, 0.00],
#                        [0.25, 0.00, 0.25],
#                        [0.00, 0.25, 0.00]])
...
#             map = convolve2d_gpu(map, kernel, 'same')
...
# highlight all the comments below and Shift + Enter to uncomment.
# CuPy with GPU (measuring all of Laplace), run this in Google Colab
