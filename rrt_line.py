...
def main():
    ...
    parent_x_array, parent_y_array, index = RRT(image, start, end, iterations, step_size, node_list)

    result = im.copy() # result image
    draw_result(image, result, start, end, parent_x_array, parent_y_array, step_size, index, node_list)
    result.show()
